#url: https://iris-370638329385.europe-west1.run.app/

import streamlit as st
import requests

 # Change this URL to the one of your API
#API_URL = "https://my-api-app-1234567891234.europe-west1.run.app/" -> lewagon API
API_URL = "https://iris-370638329385.europe-west1.run.app/"
